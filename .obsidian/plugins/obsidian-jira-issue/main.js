...
// node_modules/.pnpm/colorsys@1.0.22/node_modules/colorsys/colorsys.js
var require_colorsys = __commonJS({
  "node_modules/.pnpm/colorsys@1.0.22/node_modules/colorsys/colorsys.js"(exports, module2) {
    var RGB_MAX = 255;
    var HUE_MAX = 360;
    var SV_MAX = 100;
...
// node_modules/.pnpm/jsonpath@1.1.1/node_modules/jsonpath/jsonpath.js
var require_jsonpath = __commonJS({
  "node_modules/.pnpm/jsonpath@1.1.1/node_modules/jsonpath/jsonpath.js"(exports, module2) {
    (function(f) {
...
function buildUrl(host, requestOptions, use2025Api) {
...
function isJsonResponse(response) {
  return response.headers && response.headers["content-type"] && response.headers["content-type"].includes("json") && response.json !== void 0;
}
function isTextResponse(response) {
  return response.headers && response.headers["content-type"] && response.headers["content-type"].includes("text") && response.text !== void 0;
}
...
var JiraIssueSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  displayModifyAccountPage(prevAccount, newAccount = null) {
    ...
    colorInput.setAttr("style", "border-left: 5px solid " + newAccount.color);
    new import_obsidian2.Setting(containerEl).setName("Use 2025 search api").setDesc(`In Aug 2025, Atlassian replaced the search api with a new one. Activate this option if you use Jira Cloud or you get the error 410 when searching issues.`).addToggle((toggle) => toggle.setValue(newAccount.use2025Api).onChange(async (value) => {
...
function renderSearchCount(el, searchResults, searchView) {
  ...
  createSpan({ cls: `ji-tag ${renderingCommon_default.getTheme()}`, text: searchResults.total.toString(), title: searchView.query, parent: tagsRow });
